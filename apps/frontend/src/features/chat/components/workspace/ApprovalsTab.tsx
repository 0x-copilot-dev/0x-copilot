...
// `useApprovalsQueue` (PR 3.2). Clicking a row jumps to the inline
// <ApprovalTool> card in the thread (Atlas's "approvals as content"
// rule). PR 3.3 will split `pending` into pending-on-me vs.
