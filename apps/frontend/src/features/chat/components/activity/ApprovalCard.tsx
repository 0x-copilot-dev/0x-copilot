// PR 4.4.6.1 — purpose-built consent card for MCP / action approvals.
//
// Replaces ``ActivityCard`` for the unresolved approval surface. The
// design stripes the card into 4 zones the eye can scan in order:
//
...
//                Atlas writes outside this chat.")
//
