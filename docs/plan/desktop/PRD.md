...
# works, electron's CJS loader resolves @0x-copilot/* directly);
...
- `Router` from `@0x-copilot/chat-surface/ports/Router`
...
- [ ] All FRs met
- [ ] `npm run typecheck --workspace @0x-copilot/{pkg}` passes
- [ ] `npm test --workspace @0x-copilot/{pkg}` passes
...
3. The four [memory files](../../../.claude/projects/-Users-parthpahwa-Documents-work-0x-copilot/memory/) (project-atlas-product-model is the most important).
