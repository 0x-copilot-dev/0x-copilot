...
| AC-8  | `SubagentLifecycleStatus` gains the `"paused"` literal (additive, non-breaking per [`packages/api-types/CLAUDE.md`](../../packages/api-types/CLAUDE.md) — _"new enum values **on a payload the server already tolerates**"_; here, the server is the source emitting the literal).           | `npm run typecheck --workspace @0x-copilot/api-types`.                                                                              |
...
| AC-13 | The full ai-backend test suite passes; the frontend test suite passes.                                                                                                                                                                                                                       | `pytest tests/unit/runtime_worker/ tests/unit/agent_runtime/ tests/unit/runtime_api/`; `npm test --workspace @0x-copilot/frontend`. |
...
- [ ] `npm test --workspace @0x-copilot/frontend` → all green; new reducer cases pass.
