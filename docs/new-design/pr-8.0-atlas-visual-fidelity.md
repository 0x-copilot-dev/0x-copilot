...
- ✅ The four extracted primitives live in `packages/design-system/src/primitives/{StatusPill,ConnectorChip,AppIc,UsageMeter}/{*.tsx,*.css}`. `chat/`, `settings/`, `share/` import from `@0x-copilot/design-system` only. No surface re-skins.
