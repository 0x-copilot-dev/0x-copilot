# Design-parity report — `badge`

Design baseline (source of truth) vs live app, by computed style.

- Design: `surfaces/rail-badge/out/design-badge.json`
- Live: `surfaces/rail-badge/out/live-badge.json`

**Summary:** 🔴 HIGH 5 · 🟠 MEDIUM 42 · 🟡 LOW 19 · ⚪ INFO 13
...
| `rail.badge`         | Notification badge | display        | grid → flex             |
| `rail.badge`         | Notification badge | justifyContent | normal → center         |
| `rail.badge.absence` | Notification badge | display        | grid → flex             |
| `rail.badge.absence` | Notification badge | justifyContent | normal → center         |
...
| `rail.badge`         | Notification badge | lineHeight  | normal → 13px                                                       |
| `rail.badge.absence` | Notification badge | lineHeight  | normal → 13px                                                       |
...
| Element                | Group             | Property        | Design → Live                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------- | ----------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `shell.body.grid`      | Shell frame       | text            | “Run1ChatsProjectsActivityToolsSkillsSettingsSChatsevery conv…” → “[data-component="app-rail"] .rail-btn { transition: backgrou…”                                                                                                                                                                                                                                                                          |
| `rail.container`       | Rail              | text            | “Run1ChatsProjectsActivityToolsSkillsSettingsS” → “[data-component="app-rail"] .rail-btn { transition: backgrou…”                                                                                                                                                                                                                                                                                          |
| `rail.item.run`        | Destination items | text            | “Run1” → “1”                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `rail.item.active`     | Active state      | text            | “Chats” → “”                                                                                                                                                                                                                                                                                                                                                                                               |
