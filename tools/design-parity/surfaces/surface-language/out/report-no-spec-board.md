# Design-parity report — surface-language · `no-spec-board`
...
**Summary:** 🔴 HIGH 14 · 🟠 MEDIUM 26 · 🟡 LOW 42 · ⚪ INFO 12
...
| `nospec.note`       | The honest note  | borderRadius        | 0px → 8px                                                                                                                       |
| `row.first`         | Field rows       | gridTemplateColumns | 172px 790px → 172px 560px                                                                                                       |
...
| `row.last`          | Field rows       | gridTemplateColumns | 172px 790px → 172px 560px                                                                                                       |
| `nospec.footer`     | Read-only footer | borderWidth         | 1px 0px 0px 0px → 1px                                                                                                           |
| `nospec.footer`     | Read-only footer | borderRadius        | 0px → 8px                                                                                                                       |
...
| `nospec.note`           | The honest note  | width        | 1000px → 770px                                    |
...
| `row.first`             | Field rows       | width        | 1000px → 770px                                    |
...
| `card.kicker`   | Card             | text     | “Incident/no spec” → “Board”                                                                                                      |
| `card.kicker`   | Card             | width    | expected: intrinsic width follows dynamic runtime copy — 866.375px → 47.2031px                                                    |
| `card.title`    | Card             | text     | “Elevated 5xx on payouts-api” → “Board”                                                                                           |
| `card.title`    | Card             | width    | expected: intrinsic width follows dynamic runtime copy — 866.375px → 47.2031px                                                    |
| `row.last`      | Field rows       | text     | “Html Urlhttps://…/incidents/4127” → “Html Urlhttps://example.pagerduty.com/incidents/4127”                                       |
| `row.last`      | Field rows       | width    | expected: intrinsic width follows dynamic runtime copy — 1000px → 770px                                                           |
...
| `nospec.footer` | Read-only footer | width    | expected: intrinsic width follows dynamic runtime copy — 1000px → 770px                                                           |
