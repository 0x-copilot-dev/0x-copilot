...
**Summary:** 🔴 HIGH 28 · 🟠 MEDIUM 37 · 🟡 LOW 50 · ⚪ INFO 20
...
| `card.badge`           | Card        | fontFamily      | typeface class changed (mono → sans)                                                                                                                              |
| `card.badge`           | Card        | color           | rgb(152, 152, 159) (--mut) → rgb(212, 212, 219) (--tx2)                                                                                                           |
| `card.badge`           | Card        | borderColor     | oklch(1 0 0 / 0.115) → rgba(255, 255, 255, 0.1) (--line2)                                                                                                         |
| `card.link`            | Card        | fontFamily      | typeface class changed (mono → sans)                                                                                                                              |
| `card.link`            | Card        | fontSize        | 10.5px → 13px (+2.5px)                                                                                                                                            |
...
| `lane.first.card`      | Card chrome | backgroundColor | oklch(0.243 0.011 276) → rgb(29, 29, 35) (--panel3)                                                                                                               |
| `lane.first.card`      | Card chrome | borderColor     | oklch(1 0 0 / 0.07) → rgba(255, 255, 255, 0.1) (--line2)                                                                                                          |
...
| `card.badge`           | Card        | fontSize       | 10.5px → 11px (+0.5px)                                                                                                          |
| `card.badge`           | Card        | display        | flex → block                                                                                                                    |
| `card.badge`           | Card        | alignItems     | center → normal                                                                                                                 |
| `card.badge`           | Card        | padding        | 2px 8px → 3px 8px                                                                                                               |
| `card.badge`           | Card        | gap            | 6px → normal                                                                                                                    |
...
| `card.title`            | Card        | width         | 743.547px → 208.25px                              |
...
| `card.badge`            | Card        | letterSpacing | normal → 0.4px                                    |
| `card.badge`            | Card        | height        | 21.75px → 21px                                    |
...
| `card.kicker`          | Card        | width    | expected: intrinsic width follows dynamic runtime copy — 743.547px → 208.25px                                                     |
| `card.badge`           | Card        | text     | “7 issues” → “7 cards”                                                                                                            |
| `card.badge`           | Card        | width    | expected: intrinsic width follows dynamic runtime copy — 68.4219px → 59.3906px                                                    |
