...
**Summary:** 🔴 HIGH 13 · 🟠 MEDIUM 48 · 🟡 LOW 47 · ⚪ INFO 10
...
| `default.rowlist`           | List               | height      | 368.5px → 329.5px                                                                                                                                                                                                         |
...
| `default.row.first`         | Row                | height      | 61.25px → 158.75px                                                                                                                                                                                                        |
...
| `default.row.name`          | Row                | width       | 635.922px → 174.625px                                                                                                                                                                                                     |
