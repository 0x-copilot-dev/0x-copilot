...
| `detail.secth.chats`     | Sections      | fontSize       | 9.5px → 11.2px (+1.7px)                                    |
| `detail.secth.chats`     | Sections      | fontWeight     | 400 → 600                                                  |
| `detail.secth.chats`     | Sections      | margin         | 22px 0px 10px 0px → 0px                                    |
| `detail.rowlist.chats`   | Sections      | fontSize       | 13px → 13.6px (+0.6px)                                     |
...
| `detail.chatrow`         | Chat row      | fontSize       | 13px → 13.6px (+0.6px)                                     |
...
| `detail.secth.files`     | Sections      | fontSize       | 9.5px → 11.2px (+1.7px)                                    |
| `detail.secth.files`     | Sections      | fontWeight     | 400 → 600                                                  |
| `detail.secth.files`     | Sections      | margin         | 22px 0px 10px 0px → 0px                                    |
| `detail.rowlist.files`   | Sections      | fontSize       | 13px → 13.6px (+0.6px)                                     |
...
| `detail.secth.files`     | Sections      | width         | 912px → 40.3281px                                 |
