...
//
// The PATCH/SEND/DISCARD network calls stay host-owned — they arrive as
// the `onPatch` / `onSend` / `onDiscard` async callbacks the host wires to
// the facade (FR-1.25). This body owns only optimistic-concurrency edit
// state: every PATCH/SEND/DISCARD carries `expected_version`. On 409 the
// latest version replaces local edits; the user re-applies their edit (no
...
import { errorMessage } from "./workspaceHelpers";
