// Thought-process accordion render contract (FR-1.4). Moved down with the
// component from apps/frontend; the same assertions run from chat-surface.
//
...
//   3. Elapsed-time stamp is rendered when > 0 and empty otherwise.
