...
DEFAULT_CATALOG: tuple[CatalogEntry, ...] = (
    CatalogEntry(
        ...
        description="Pull the plan, chase what is slipping, write the update.",
        brand_color="#F06A6A",
        scopes_summary="Read tasks and comments. No deletes.",
    ...
    CatalogEntry(
        ...
        description="Read the board, find the blocker, draft the ticket.",
        brand_color="#2684FF",
        scopes_summary="Read Jira issues and Confluence pages.",
        default_scopes=("read",),
    ...
    CatalogEntry(
        ...
        description="Check what is actually wired up before you ship.",
        verified=False,
        brand_color="#F38020",
    ...
    CatalogEntry(
        ...
        transport=McpTransport.SSE,
        description="Find the spike, trace it, and explain what broke.",
        verified=False,
        brand_color="#F38020",
    ...
    CatalogEntry(
        ...
        description="Work the PR queue and summarise what is waiting on you.",
        verified=False,
        brand_color="#0D1117",
        scopes_summary="Read repos. No writes.",
        default_scopes=("read",),
        requires_pre_registered_client=True,
    ),
    CatalogEntry(
        ...
        transport=McpTransport.SSE,
        description="Read the week's conversations and draft the replies.",
        verified=False,
        brand_color="#1F8DED",
    ...
    CatalogEntry(
        ...
        description="Pull the board, spot the real blocker, draft the fix.",
        brand_color="#5E6AD2",
    ...
    CatalogEntry(
        ...
        description="Read the brief, keep the page current, write the recap.",
        brand_color="#000000",
    ...
    CatalogEntry(
        ...
        transport=McpTransport.SSE,
        description="Reconcile payments and flag the disputes worth your time.",
        verified=False,
        brand_color="#003087",
    ...
    CatalogEntry(
        ...
        transport=McpTransport.SSE,
        description="Read balances and transactions, and close out the month.",
        verified=False,
        brand_color="#111111",
    ...
    CatalogEntry(
        ...
        description="Triage new errors and explain the stack trace in English.",
        verified=False,
        brand_color="#362D59",
    ...
    CatalogEntry(
        ...
        transport=McpTransport.SSE,
        description="Watch orders and inventory, and surface what to restock.",
        verified=False,
        brand_color="#000000",
        scopes_summary="Read payments, orders, and inventory.",
        default_scopes=("read",),
        requires_pre_registered_client=True,
    ),
    CatalogEntry(
        ...
        description="Reach thousands of apps that have no connector of their own.",
        brand_color="#FF4A00",
