...
- `docs/specs/internal-api.md` — detailed contract spec for internal routes
- `docs/specs/auth/A5-saml.md`, `A7-scim.md`, `A10-rbac.md` — auth implementation contracts
- `ARCHITECTURE.md` — module map and API surface overview (superseded by this KB but kept for reference)
- `TESTING.md` — test commands and coverage areas
