...
- [x] P22 — **PRD drafted + PR 2/5 shipped 2026-05-12**: [`19-runtime-api-service-split.md`](19-runtime-api-service-split.md).
  ...
  - **Next: PR 3 (no-op — worker doesn't import RuntimeApiService) → PR 4 (dependency unwrapping: move method bodies into coordinators, each takes its own port/resolver slice; app.py wires slices directly).**
